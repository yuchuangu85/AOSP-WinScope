...
exports.WasmEngineProxy = void 0;
...
let idleWasmWorker;
function initWasm() {
    idleWasmWorker = new Worker((0, assets_1.assetSrc)('engine_bundle.js'));
}
/**
 ...
 */
class WasmEngineProxy extends engine_1.EngineBase {
    mode = 'WASM';
    id;
    port;
    worker;
    constructor(id) {
        ...
        this.worker = (0, logging_1.assertExists)(idleWasmWorker);
        idleWasmWorker = new Worker((0, assets_1.assetSrc)('engine_bundle.js'));
        this.worker.postMessage(port1, [port1]);
        this.port.onmessage = this.onMessage.bind(this);
    }
    onMessage(m) {
        (0, logging_1.assertTrue)(m.data instanceof Uint8Array);
...
//# sourceMappingURL=wasm_engine_proxy.js.map