...
const inheritanceTree = new Map([
    [exports.NUM, { extends: exports.NUM_NULL }],
    [exports.NUM_NULL, { extends: exports.UNKNOWN }],
    [exports.LONG, { extends: exports.LONG_NULL }],
    [exports.LONG_NULL, { extends: exports.UNKNOWN }],
    [exports.BLOB, { extends: exports.BLOB_NULL }],
    [exports.BLOB_NULL, { extends: exports.UNKNOWN }],
    [exports.STR, { extends: exports.STR_NULL }],
    [exports.STR_NULL, { extends: exports.UNKNOWN }],
    [exports.UNKNOWN, {}],
]);
/**
 ...
 */
function checkExtends(required, actual) {
 ...
 */
function unionTypes(typeA, typeB) {
