...
const breakdown_tracks_1 = require("../../components/tracks/breakdown_tracks");
class default_1 {
    static id = 'dev.perfetto.AndroidBinderVizPlugin';
    async onTraceLoad(ctx) {
        const binderCounterBreakdowns = new breakdown_tracks_1.BreakdownTracks({
            trace: ctx,
            trackTitle: 'Binder Transaction Counts',
            modules: ['android.binder', 'android.binder_breakdown'],
            aggregationType: breakdown_tracks_1.BreakdownTrackAggType.COUNT,
            aggregation: {
                columns: [
                    'server_process',
