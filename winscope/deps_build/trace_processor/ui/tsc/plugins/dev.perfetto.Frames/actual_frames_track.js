...
exports.createActualFramesTrack = createActualFramesTrack;
...
function createActualFramesTrack(trace, uri, maxDepth, trackIds) {
    return new dataset_slice_track_1.DatasetSliceTrack({
        ...
        dataset: new dataset_1.SourceDataset({
            ...
            schema: {
                ...
                jank_tag: query_result_1.STR_NULL,
                jank_severity_type: query_result_1.STR_NULL,
            },
            filter: {
                col: 'track_id',
                in: trackIds,
