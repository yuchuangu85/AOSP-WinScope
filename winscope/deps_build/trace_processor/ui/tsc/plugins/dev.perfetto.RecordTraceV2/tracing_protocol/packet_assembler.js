...
class PacketAssembler {
     ...
     */
    pushSlices(rdResp) {
        const traceBuf = new resizable_array_buffer_1.ResizableArrayBuffer(4096);
        for (const slice of rdResp.slices ?? []) {
            if (!(0, utils_1.exists)(slice.data))
                continue;
            ...
            const preamble = [TRACE_PACKET_PROTO_TAG];
