...
exports.prefixWithHexLen = prefixWithHexLen;
exports.websocketInstructions = websocketInstructions;
exports.disposeWebsocket = disposeWebsocket;
...
function prefixWithHexLen(cmd) {
    const hdr = cmd.length.toString(16).padStart(4, '0');
    return hdr + cmd;
}
function websocketInstructions(os) {
    return ('Instructions:\n' +
...
//# sourceMappingURL=websocket_utils.js.map