...
function gpuRenderStages() {
    return {
        id: 'gpu_renderstages',
        title: 'GPU Render Stages',
        description: 'Records GPU render stage events. To check if your device supports this feature run:' +
...
function gpuMaliCounters() {
    return {
        id: 'gpu_mali_counters',
        title: 'Mali GPU Counters',
        description: 'Records Mali GPU performance counters (Available on Valhall+).' +
