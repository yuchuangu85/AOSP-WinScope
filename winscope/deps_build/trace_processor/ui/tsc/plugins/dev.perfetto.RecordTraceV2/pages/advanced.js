...
exports.ADV_FTRACE_PROBE_ID = exports.PROC_STATS_DS_NAME = exports.ADV_PROC_ASSOC_PROBE_ID = void 0;
exports.advancedRecordSection = advancedRecordSection;
const trace_config_builder_1 = require("../config/trace_config_builder");
...
exports.ADV_PROC_ASSOC_PROBE_ID = 'adv_proc_thread_assoc';
exports.PROC_STATS_DS_NAME = 'linux.process_stats';
exports.ADV_FTRACE_PROBE_ID = 'advanced_ftrace';
function advancedRecordSection() {
    return {
        kind: 'PROBES_PAGE',
        id: 'advanced',
...
function ftraceCfg() {
    const settings = {
        ...
        genericEvents: new toggle_1.Toggle({
            title: 'Enable generic events (slow)',
            descr: 'Enables capture of ftrace events that are not known at build time ' +
                'by perfetto as key-value string pairs. This is slow and expensive.',
        }),
        bufSize: new slider_1.Slider({
            title: 'Buf size',
            cssClass: '.thin',
        ...
        groups: new multiselect_1.TypedMultiselect({
            title: 'Event groups',
    ...
    return {
        id: exports.ADV_FTRACE_PROBE_ID,
        title: 'Advanced ftrace config',
        image: 'rec_ftrace.png',
        description: 'Enable individual events and tune the kernel-tracing (ftrace) ' +
        ...
        genConfig: function (tc) {
            const ds = tc.addDataSource(trace_config_builder_1.FTRACE_DS);
...
function procThreadAssociation() {
    const ftraceEvents = [
    ...
    const settings = {
        initialScan: new toggle_1.Toggle({
    ...
    return {
        id: exports.ADV_PROC_ASSOC_PROBE_ID,
        title: 'Process<>thread association',
        description: 'A union of ftrace events and /proc scrapers to capture thread<>process' +
