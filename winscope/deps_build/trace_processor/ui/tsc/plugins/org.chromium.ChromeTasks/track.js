...
exports.createChromeTasksThreadTrack = createChromeTasksThreadTrack;
...
function createChromeTasksThreadTrack(trace, uri, utid) {
    return new dataset_slice_track_1.DatasetSliceTrack({
        ...
        detailsPanel: (row) => new details_1.ChromeTasksDetailsPanel(trace, row.id),
    });
}
