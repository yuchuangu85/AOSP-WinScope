...
class default_1 {
    ...
    async addDeviceState(ctx, features) {
        ...
        await this.addSliceTrack(ctx, 'Device State: Screen state', `SELECT ts, dur, screen_state AS name FROM android_screen_state`);
        await this.addSliceTrack(ctx, 'Device State: Charging', `SELECT ts, dur, charging_state AS name FROM android_charging_states`);
        await this.addSliceTrack(ctx, 'Device State: Suspend / resume', SUSPEND_RESUME);
        await this.addSliceTrack(ctx, 'Device State: Doze light state', `SELECT ts, dur, light_idle_state AS name FROM android_light_idle_state`);
