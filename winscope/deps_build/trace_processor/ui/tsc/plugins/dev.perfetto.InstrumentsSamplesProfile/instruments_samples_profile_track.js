...
exports.createProcessInstrumentsSamplesProfileTrack = createProcessInstrumentsSamplesProfileTrack;
exports.createThreadInstrumentsSamplesProfileTrack = createThreadInstrumentsSamplesProfileTrack;
...
function createProcessInstrumentsSamplesProfileTrack(trace, uri, upid) {
    return new dataset_slice_track_1.DatasetSliceTrack({
      ...
      `,
        ...
        `, [
            ...
            ], 'include perfetto module appleos.instruments.samples', [{ name: 'mapping_name', displayName: 'Mapping' }], [
                {
                    name: 'source_file',
...
function createThreadInstrumentsSamplesProfileTrack(trace, uri, utid) {
    return new dataset_slice_track_1.DatasetSliceTrack({
        trace,
        uri,
        dataset: new dataset_1.SourceDataset({
...
function renderDetailsPanel(flamegraph, ts) {
    return (0, mithril_1.default)('.flamegraph-profile', (0, mithril_1.default)(details_shell_1.DetailsShell, {
        fillParent: true,
        title: (0, mithril_1.default)('.title', 'Instruments Samples'),
        description: [],
        buttons: [
...
//# sourceMappingURL=instruments_samples_profile_track.js.map