...
const validMetricsTest = [
    {
        inputMetric: 'perfetto_cuj_systemui-NOTIFICATION_SHADE_EXPAND_COLLAPSE::Expand-timeline_metrics-missed_app_frames-mean',
        expectedOutput: {
    ...
    {
        inputMetric: 'perfetto_cuj_systemui-SHADE_DIALOG_OPEN::internet-timeline_metrics-missed_sf_frames-mean',
        expectedOutput: {
            process: 'com.android.systemui',
    ...
    {
        inputMetric: 'perfetto_cuj_launcher-RECENTS_SCROLLING-counter_metrics-missed_sf_frames-mean',
        expectedOutput: {
...
const tester = pinCujScoped_1.pinCujScopedJankInstance;
...
//# sourceMappingURL=pinCujScoped_unittest.js.map