...
test('query_builder.basic_select', () => {
    expect(normalise((0, query_builder_1.buildSqlQuery)({
        table: 'slice',
        columns: {
            id: 'id',
        },
...
test('query_builder.basic_filter', () => {
    ...
    }))).toBe('SELECT slice_0.id AS id FROM slice AS slice_0 WHERE slice_0.ts != -1');
});
test('query_builder.basic_order_by', () => {
    ...
    }))).toBe('SELECT slice_0.id AS id FROM slice AS slice_0 ORDER BY slice_0.ts ASC');
});
            ...
            arg1: {
                ...
                source: {
                    ...
                    joinOn: {
                        ...
                        key: (0, string_utils_1.sqliteString)('arg1'),
                    },
                },
            },
            arg2: {
                ...
                source: {
                    ...
                    joinOn: {
                        arg_set_id: 'arg_set_id',
                        key: (0, string_utils_1.sqliteString)('arg2'),
                    },
                },
            },
        },
...
//# sourceMappingURL=query_builder_unittest.js.map