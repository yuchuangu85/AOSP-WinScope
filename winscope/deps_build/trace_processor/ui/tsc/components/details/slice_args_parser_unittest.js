...
describe('convertArgsToTree', () => {
    test('converts example arg set', () => {
        expect((0, slice_args_parser_1.convertArgsToTree)(args)).toEqual([
            {
                key: 'simple_key',
...
describe('convertArgsToObject', () => {
    it('converts example arg set', () => {
        expect((0, slice_args_parser_1.convertArgsToObject)(args)).toEqual({
    ...
    test('throws on args containing a node with both value and children', () => {
        expect(() => {
            (0, slice_args_parser_1.convertArgsToObject)([
                { key: 'foo', value: 'foo' },
                { key: 'foo.bar', value: 'bar' },
            ]);
        }).toThrow();
    ...
    test('picks last one where duplicate keys exist', () => {
        ...
        expect((0, slice_args_parser_1.convertArgsToObject)(args)).toEqual({ foo: 'bar' });
    });
    test('handles sparse arrays', () => {
...
//# sourceMappingURL=slice_args_parser_unittest.js.map