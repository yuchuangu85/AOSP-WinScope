...
exports.GcsUploader = exports.MIME_BINARY = exports.MIME_JSON = exports.BUCKET_NAME = void 0;
const deferred_1 = require("./deferred");
const time_1 = require("./time");
exports.BUCKET_NAME = 'perfetto-ui-data';
exports.MIME_JSON = 'application/json; charset=utf-8';
...
class GcsUploader {
    ...
    onProgress;
    req;
    donePromise = (0, deferred_1.defer)();
    ...
    async start(data) {
        ...
        this.uploadedUrl = `https://storage.googleapis.com/${exports.BUCKET_NAME}/${fname}`;
        // Check if the file has been uploaded already. If so, skip.
        const res = await fetch(`https://www.googleapis.com/storage/v1/b/${exports.BUCKET_NAME}/o/${fname}`);
        if (res.status === 200) {
        ...
        const reqUrl = 'https://www.googleapis.com/upload/storage/v1/b/' +
        ...
        const mimeType = this.args.mimeType ?? exports.MIME_BINARY;
    ...
    getEtaString() {
        ...
        str += ' - ETA: ' + time_1.Time.toTimecode(time_1.Time.fromSeconds(etaSecs)).dhhmmss;
        return str;
    }
    onRpcEvent(e) {
        let done = false;
...
exports.GcsUploader = GcsUploader;
/**
...
//# sourceMappingURL=gcs_uploader.js.map