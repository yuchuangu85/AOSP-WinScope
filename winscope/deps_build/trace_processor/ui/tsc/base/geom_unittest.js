...
describe('Rect2D', () => {
    test('asPoint', () => {
        const rect = new geom_1.Rect2D({ left: 1, top: 2, right: 3, bottom: 4 });
        expect(rect).toMatchObject({ x: 1, y: 2 });
    });
    test('asSize', () => {
        const rect = new geom_1.Rect2D({ left: 1, top: 2, right: 3, bottom: 8 });
    ...
    test('fromPoints', () => {
        const rect = geom_1.Rect2D.fromPoints({ x: 0, y: 0 }, { x: 100, y: 100 });
    ...
    test('fromPoints reversed', () => {
        const rect = geom_1.Rect2D.fromPoints({ x: 100, y: 100 }, { x: 0, y: 0 });
        expect(rect.left).toBe(0);
        expect(rect.top).toBe(0);
        expect(rect.right).toBe(100);
        expect(rect.bottom).toBe(100);
