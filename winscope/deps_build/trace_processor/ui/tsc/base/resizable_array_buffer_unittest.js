...
const resizable_array_buffer_1 = require("./resizable_array_buffer");
test('ResizableArrayBuffer.simple', () => {
    const buf = new resizable_array_buffer_1.ResizableArrayBuffer();
    buf.append([1, 2]);
...
test('ResizableArrayBuffer.merge', () => {
    ...
    const randU8 = () => ((0, rand_1.pseudoRand)(randState) * 256) & 0xff;
...
//# sourceMappingURL=resizable_array_buffer_unittest.js.map