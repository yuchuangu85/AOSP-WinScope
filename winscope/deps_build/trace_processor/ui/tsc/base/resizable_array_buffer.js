...
exports.ResizableArrayBuffer = void 0;
...
class ResizableArrayBuffer {
    ...
    shrink(newSize) {
        (0, logging_1.assertTrue)(newSize <= this._size);
        this._size = newSize;
    }
    clear() {
    ...
    grow(capacityNeeded) {
        ...
        (0, logging_1.assertTrue)(newBuf.length >= capacityNeeded);
        newBuf.set(this.buf);
        this.buf = newBuf;
    }
}
exports.ResizableArrayBuffer = ResizableArrayBuffer;
//# sourceMappingURL=resizable_array_buffer.js.map