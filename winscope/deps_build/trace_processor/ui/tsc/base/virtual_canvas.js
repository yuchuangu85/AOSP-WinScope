...
class VirtualCanvas {
    ...
    _canvasRect;
    _viewportLimits;
    _layoutShiftListener;
    _canvasResizeListener;
    _dpr;
    /**
     ...
     */
    constructor(targetElement, containerElement, opts) {
        const { overdrawPx = 200, tolerancePx = 100, overdrawAxes: scrollAxes = 'none', } = opts ?? {};
        ...
        const getCanvasRect = () => {
            ...
            if (this._viewportLimits.contains(viewport)) {
                ...
                this._viewportLimits = viewport.expand({
                    height: scrollAxes === 'both' || scrollAxes === 'y' ? viewportOversize : 0,
                    width: scrollAxes === 'both' || scrollAxes === 'x' ? viewportOversize : 0,
                });
                return canvasRect;
            }
        };
        const updateCanvas = () => {
            ...
            if (canvasRectPrev.width !== canvasRect.width ||
                ...
                this._canvasResizeListener?.(canvas, canvasRect.width, canvasRect.height);
                repaintRequired = true;
            }
            if (canvasRectPrev.left !== canvasRect.left ||
        ...
        this._trash.defer(() => containerElement.removeEventListener('scroll', updateCanvas));
        ...
        this._canvasRect = new geom_1.Rect2D({
            left: 0,
            top: 0,
            bottom: 0,
            right: 0,
