...
const shared_disposable_1 = require("./shared_disposable");
describe('SharedDisposableAsync', () => {
    it('allows access to the underlying disposable', async () => {
        ...
        const shared = shared_disposable_1.SharedAsyncDisposable.wrap(disposable);
    ...
    it('only disposes after refcount drops to 0', async () => {
        ...
        order.push('create a');
        const a = shared_disposable_1.SharedAsyncDisposable.wrap(disposable);
        order.push('clone b');
        const b = a.clone();
...
//# sourceMappingURL=shared_disposable_unittest.js.map