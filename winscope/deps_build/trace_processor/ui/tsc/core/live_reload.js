...
exports.initLiveReload = initLiveReload;
...
const rapidReloadFlag = feature_flags_1.featureFlags.register({
    id: 'rapidReload',
...
function reloadDelayed() {
    setTimeout(() => {
        ...
        if (Date.now() - lastReloadDialogTime < kMinTimeBetweenDialogsMs)
            return;
        const reload = rapidReloadFlag.get() || confirm(`${pathsStr}changed, click to reload`);
...
//# sourceMappingURL=live_reload.js.map