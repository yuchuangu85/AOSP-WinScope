 ...
 public:
  ...
  struct Row : public macros_internal::RootParentTable::Row {
    ...
    bool operator==(const StackProfileMappingTable::Row& other) const {
      return ColumnType::build_id::Equals(build_id, other.build_id) &&
...
,
    ...
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,build_id_storage_layer_,exact_offset_storage_layer_,start_offset_storage_layer_,start_storage_layer_,end_storage_layer_,load_bias_storage_layer_,name_storage_layer_},
      {{},{},{},{},{},{},{},{}});
  }
...
,
    ...
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,name_storage_layer_,mapping_storage_layer_,rel_pc_storage_layer_,symbol_set_id_storage_layer_,deobfuscated_name_storage_layer_},
 ...
 public:
  ...
  struct Row : public macros_internal::RootParentTable::Row {
    ...
    bool operator==(const StackProfileCallsiteTable::Row& other) const {
      return ColumnType::depth::Equals(depth, other.depth) &&
...
,
    ...
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,depth_storage_layer_,parent_id_storage_layer_,frame_id_storage_layer_},
...
,
    ...
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,ts_storage_layer_,callsite_id_storage_layer_,utid_storage_layer_,process_priority_storage_layer_},
      {{},{},{},{},{}});
  }
...
class ExperimentalFlamegraphTable : public macros_internal::MacroTable {
 public:
  static constexpr uint32_t kColumnCount = 22;
  ...
  struct Row : public macros_internal::RootParentTable::Row {
    ...
    bool operator==(const ExperimentalFlamegraphTable::Row& other) const {
      return ColumnType::profile_type::Equals(profile_type, other.profile_type) &&
 ...
 public:
  ...
  struct Row : public macros_internal::RootParentTable::Row {
    ...
    bool operator==(const GpuCounterGroupTable::Row& other) const {
      return ColumnType::group_id::Equals(group_id, other.group_id) &&
...
,
    ...
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,group_id_storage_layer_,track_id_storage_layer_},
      {{},{},{}});
  }
...
,
    ...
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,name_storage_layer_,deobfuscated_name_storage_layer_,location_storage_layer_,superclass_id_storage_layer_,classloader_id_storage_layer_,kind_storage_layer_},
      {{},{},{},{},superclass_id_null_layer_,classloader_id_null_layer_,{}});
  }
  ~HeapGraphClassTable() override;

  static const char* Name() { return "__intrinsic_heap_graph_class"; }
...
class HeapGraphObjectTable : public macros_internal::MacroTable {
 public:
  ...
  struct ColumnType {
    ...
    using heap_type = TypedColumn<std::optional<StringPool::Id>>;
  ...
  struct Row : public macros_internal::RootParentTable::Row {
    Row(uint32_t in_upid = {},
        ...
        std::optional<StringPool::Id> in_heap_type = {},
    ...
    bool operator==(const HeapGraphObjectTable::Row& other) const {
      return ColumnType::upid::Equals(upid, other.upid) &&
       ...
       ColumnType::heap_type::Equals(heap_type, other.heap_type) &&
  ...
  struct ColumnFlag {
    ...
    static constexpr uint32_t heap_type = ColumnType::heap_type::default_flags();
  ...
  class ConstRowReference : public macros_internal::AbstractConstRowReference<
   ...
   public:
    ...
    ColumnType::heap_type::type heap_type() const {
      return table()->heap_type()[row_number_];
    }
  ...
  class RowReference : public ConstRowReference {
   public:
    ...
    void set_heap_type(
        ColumnType::heap_type::non_optional_type v) {
      return mutable_table()->mutable_heap_type()->Set(row_number_, v);
    }
    void set_type_id(
  ...
  class ConstIterator : public macros_internal::AbstractConstIterator<
   ...
   public:
    ...
    ColumnType::heap_type::type heap_type() const {
      const auto& col = table()->heap_type();
      return col.GetAtIdx(
        iterator_.StorageIndexForColumn(col.index_in_table()));
    }
    ColumnType::type_id::type type_id() const {
  ...
  static std::vector<ColumnLegacy> GetColumns(
    ...
    AddColumnToVector(columns, "reachable", &self->reachable_, ColumnFlag::reachable,
                      static_cast<uint32_t>(columns.size()), olay_idx);
    AddColumnToVector(columns, "heap_type", &self->heap_type_, ColumnFlag::heap_type,
                      static_cast<uint32_t>(columns.size()), olay_idx);
  ...
  PERFETTO_NO_INLINE explicit HeapGraphObjectTable(StringPool* pool)
      : macros_internal::MacroTable(
        ...
        heap_type_(ColumnStorage<ColumnType::heap_type::stored_type>::Create<false>()),
...
,
        ...
        new column::NumericStorage<ColumnType::reachable::non_optional_stored_type>(
          ...
          false)),
        heap_type_storage_layer_(
          new column::StringStorage(string_pool(), &heap_type_.vector())),
...
,
    ...
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
      static_assert(
        ColumnLegacy::IsFlagsAndTypeValid<ColumnType::heap_type::stored_type>(
          ColumnFlag::heap_type),
        "Column type and flag combination is not valid");
      static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,upid_storage_layer_,graph_sample_ts_storage_layer_,self_size_storage_layer_,native_size_storage_layer_,reference_set_id_storage_layer_,reachable_storage_layer_,heap_type_storage_layer_,type_id_storage_layer_,root_type_storage_layer_,root_distance_storage_layer_},
      {{},{},{},{},{},reference_set_id_null_layer_,{},{},{},{},{}});
  }
  ~HeapGraphObjectTable() override;

  static const char* Name() { return "__intrinsic_heap_graph_object"; }
  ...
  static Table::Schema ComputeStaticSchema() {
    ...
    schema.columns.emplace_back(Table::Schema::Column{
        ...
        false});
    schema.columns.emplace_back(Table::Schema::Column{
        "heap_type", ColumnType::heap_type::SqlValueType(), false,
        false,
        false,
        false});
    schema.columns.emplace_back(Table::Schema::Column{
  ...
  IdAndRow Insert(const Row& row) {
    ...
    mutable_heap_type()->Append(row.heap_type);
  ...
  const TypedColumn<std::optional<StringPool::Id>>& heap_type() const {
    return static_cast<const ColumnType::heap_type&>(columns()[ColumnIndex::heap_type]);
  }
  ...
  TypedColumn<std::optional<StringPool::Id>>* mutable_heap_type() {
    return static_cast<ColumnType::heap_type*>(
        GetColumn(ColumnIndex::heap_type));
  }
 ...
 private:
  ...
  ColumnStorage<ColumnType::heap_type::stored_type> heap_type_;
  ...
  RefPtr<column::StorageLayer> heap_type_storage_layer_;
 ...
 public:
  ...
  struct Row : public macros_internal::RootParentTable::Row {
    ...
    bool operator==(const HeapGraphReferenceTable::Row& other) const {
      return ColumnType::reference_set_id::Equals(reference_set_id, other.reference_set_id) &&
...
,
    ...
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,reference_set_id_storage_layer_,owner_id_storage_layer_,owned_id_storage_layer_,field_name_storage_layer_,field_type_name_storage_layer_,deobfuscated_field_name_storage_layer_},
      {{},{},{},owned_id_null_layer_,{},{},{}});
  }
  ~HeapGraphReferenceTable() override;

  static const char* Name() { return "__intrinsic_heap_graph_reference"; }
...
,
    ...
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,ts_storage_layer_,utid_storage_layer_,callsite_id_storage_layer_,cpu_storage_layer_},
      {{},{},{},callsite_id_null_layer_,cpu_null_layer_});
  }
...
,
    ...
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,ts_storage_layer_,upid_storage_layer_,heap_name_storage_layer_,callsite_id_storage_layer_,count_storage_layer_,size_storage_layer_},
      {{},{},{},{},{},{},{}});
  }
...
,
    ...
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,package_name_storage_layer_,uid_storage_layer_,debuggable_storage_layer_,profileable_from_shell_storage_layer_,version_code_storage_layer_},
      {{},{},{},{},{},{}});
  }
 ...
 public:
  ...
  struct Row : public macros_internal::RootParentTable::Row {
    ...
    bool operator==(const PerfSessionTable::Row& other) const {
      return ColumnType::cmdline::Equals(cmdline, other.cmdline);
    }
  };
  struct ColumnFlag {
...
,
    ...
    static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,cmdline_storage_layer_},
      {{},{}});
  }
...
,
    ...
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,ts_storage_layer_,utid_storage_layer_,cpu_storage_layer_,cpu_mode_storage_layer_,callsite_id_storage_layer_,unwind_error_storage_layer_,perf_session_id_storage_layer_},
 ...
 public:
  ...
  struct Row : public macros_internal::RootParentTable::Row {
    ...
    bool operator==(const SymbolTable::Row& other) const {
      return ColumnType::symbol_set_id::Equals(symbol_set_id, other.symbol_set_id) &&
       ColumnType::name::Equals(name, other.name) &&
       ColumnType::source_file::Equals(source_file, other.source_file) &&
       ColumnType::line_number::Equals(line_number, other.line_number);
    }
...
,
    ...
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,symbol_set_id_storage_layer_,name_storage_layer_,source_file_storage_layer_,line_number_storage_layer_},
