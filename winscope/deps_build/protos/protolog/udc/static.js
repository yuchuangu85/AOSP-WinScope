...
(function(global, factory) { /* global define, require, module */
            ...
            android.internal = (function() {
                ...
                internal.protolog = (function() {
                    ...
                    protolog.ProtoLogMessage = (function() {
                         ...
                         */
                        ProtoLogMessage.decode = function decode(reader, length, error) {
                    ...
                    protolog.ProtoLogFileProto = (function() {
                         ...
                         * @throws {$protobuf.util.ProtocolError} If required fields are missing
                         */
                        ProtoLogFileProto.decode = function decode(reader, length, error) {
                            if (!(reader instanceof $Reader))
                                reader = $Reader.create(reader);
                            ...
                            while (reader.pos < end) {
                                ...
                                case 4: {
                                        if (!(message.log && message.log.length))
                                            message.log = [];
                                        message.log.push($root.com.android.internal.protolog.ProtoLogMessage.decode(reader, reader.uint32()));
                                        break;
                                    }
                                default:
                                    reader.skipType(tag & 7);
                         ...
                         * @returns {string|null} `null` if valid, otherwise the reason why it is not
                         */
                        ProtoLogFileProto.verify = function verify(message) {
                            if (typeof message !== "object" || message === null)
                                return "object expected";
                            ...
                            if (message.log != null && message.hasOwnProperty("log")) {
                                ...
                                for (var i = 0; i < message.log.length; ++i) {
                                    var error = $root.com.android.internal.protolog.ProtoLogMessage.verify(message.log[i]);
                                    if (error)
                                        return "log." + error;
                                }
                            }
                         ...
                         * @returns {com.android.internal.protolog.ProtoLogFileProto} ProtoLogFileProto
                         */
                        ProtoLogFileProto.fromObject = function fromObject(object) {
                            ...
                            if (object.log) {
                                ...
                                for (var i = 0; i < object.log.length; ++i) {
                                    ...
                                    message.log[i] = $root.com.android.internal.protolog.ProtoLogMessage.fromObject(object.log[i]);
                                }
                            }
                            return message;
                        };
    ...
    $root.android = (function() {
        ...
        android.PrivacyFlags = (function() {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            PrivacyFlags.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
             ...
             * @returns {string|null} `null` if valid, otherwise the reason why it is not
             */
            PrivacyFlags.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
             ...
             * @returns {android.PrivacyFlags} PrivacyFlags
             */
            PrivacyFlags.fromObject = function fromObject(object) {
            ...
            protobuf.MessageOptions = (function() {
                ...
                MessageOptions.decode = function decode(reader, length, error) {
                    ...
                    while (reader.pos < end) {
                        ...
                        case 102672883: {
                                message[".android.msgPrivacy"] = $root.android.PrivacyFlags.decode(reader, reader.uint32());
                                break;
                            }
                        default:
                            reader.skipType(tag & 7);
                ...
                MessageOptions.verify = function verify(message) {
                    ...
                    if (message[".android.msgPrivacy"] != null && message.hasOwnProperty(".android.msgPrivacy")) {
                        var error = $root.android.PrivacyFlags.verify(message[".android.msgPrivacy"]);
                        if (error)
                ...
                MessageOptions.fromObject = function fromObject(object) {
                    ...
                    if (object[".android.msgPrivacy"] != null) {
                        ...
                        message[".android.msgPrivacy"] = $root.android.PrivacyFlags.fromObject(object[".android.msgPrivacy"]);
                    }
                    return message;
                };
            ...
            protobuf.FieldOptions = (function() {
                ...
                FieldOptions.decode = function decode(reader, length, error) {
                    ...
                    while (reader.pos < end) {
                        ...
                        case 102672883: {
                                message[".android.privacy"] = $root.android.PrivacyFlags.decode(reader, reader.uint32());
                                break;
                            }
                        default:
                            reader.skipType(tag & 7);
                ...
                FieldOptions.verify = function verify(message) {
                    ...
                    if (message[".android.privacy"] != null && message.hasOwnProperty(".android.privacy")) {
                        var error = $root.android.PrivacyFlags.verify(message[".android.privacy"]);
                        if (error)
                ...
                FieldOptions.fromObject = function fromObject(object) {
                    ...
                    if (object[".android.privacy"] != null) {
                        ...
                        message[".android.privacy"] = $root.android.PrivacyFlags.fromObject(object[".android.privacy"]);
                    }
                    return message;
                };
