...
(function(global, factory) { /* global define, require, module */
    ...
    var $root = $protobuf.roots.transactionslatest || ($protobuf.roots.transactionslatest = {});
    ...
    $root.perfetto = (function() {
        ...
        perfetto.protos = (function() {
            ...
            protos.TransactionTraceFile = (function() {
                 ...
                 * @property {Array.<perfetto.protos.ITransactionTraceEntry>|null} [entry] TransactionTraceFile entry
                 ...
                 * @constructor
                 * @param {perfetto.protos.ITransactionTraceFile=} [properties] Properties to set
                 */
                 ...
                 * @memberof perfetto.protos.TransactionTraceFile
                 * @instance
                 */
                 ...
                 * @member {Array.<perfetto.protos.ITransactionTraceEntry>} entry
                 * @memberof perfetto.protos.TransactionTraceFile
                 * @instance
                 */
                 ...
                 * @static
                 * @param {perfetto.protos.ITransactionTraceFile=} [properties] Properties to set
                 * @returns {perfetto.protos.TransactionTraceFile} TransactionTraceFile instance
                 */
                ...
                /**
                 * Encodes the specified TransactionTraceFile message. Does not implicitly {@link perfetto.protos.TransactionTraceFile.verify|verify} messages.
                 * @function encode
                 * @memberof perfetto.protos.TransactionTraceFile
                 * @static
                 * @param {perfetto.protos.ITransactionTraceFile} message TransactionTraceFile message or plain object to encode
                ...
                TransactionTraceFile.encode = function encode(message, writer) {
                    ...
                    if (message.entry != null && message.entry.length)
                        for (var i = 0; i < message.entry.length; ++i)
                            $root.perfetto.protos.TransactionTraceEntry.encode(message.entry[i], writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                ...
                /**
                 * Encodes the specified TransactionTraceFile message, length delimited. Does not implicitly {@link perfetto.protos.TransactionTraceFile.verify|verify} messages.
                 ...
                 * @returns {perfetto.protos.TransactionTraceFile} TransactionTraceFile
                ...
                TransactionTraceFile.decode = function decode(reader, length) {
                    ...
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.perfetto.protos.TransactionTraceFile();
                    while (reader.pos < end) {
                        ...
                        case 2: {
                                if (!(message.entry && message.entry.length))
                                    message.entry = [];
                                message.entry.push($root.perfetto.protos.TransactionTraceEntry.decode(reader, reader.uint32()));
                                break;
                            }
                        case 3: {
                ...
                TransactionTraceFile.verify = function verify(message) {
                    ...
                    if (message.entry != null && message.hasOwnProperty("entry")) {
                        ...
                        for (var i = 0; i < message.entry.length; ++i) {
                            var error = $root.perfetto.protos.TransactionTraceEntry.verify(message.entry[i]);
                            if (error)
                                return "entry." + error;
                        }
                    }
                ...
                TransactionTraceFile.fromObject = function fromObject(object) {
                    if (object instanceof $root.perfetto.protos.TransactionTraceFile)
                        return object;
                    var message = new $root.perfetto.protos.TransactionTraceFile();
                    ...
                    if (object.entry) {
                        if (!Array.isArray(object.entry))
                            throw TypeError(".perfetto.protos.TransactionTraceFile.entry: array expected");
                        message.entry = [];
                        for (var i = 0; i < object.entry.length; ++i) {
                            if (typeof object.entry[i] !== "object")
                                throw TypeError(".perfetto.protos.TransactionTraceFile.entry: object expected");
                            message.entry[i] = $root.perfetto.protos.TransactionTraceEntry.fromObject(object.entry[i]);
                        }
                    }
                 ...
                 * @memberof perfetto.protos.TransactionTraceFile
                 * @static
                 * @param {perfetto.protos.TransactionTraceFile} message TransactionTraceFile
                ...
                TransactionTraceFile.toObject = function toObject(message, options) {
                    ...
                    if (message.entry && message.entry.length) {
                        ...
                        for (var j = 0; j < message.entry.length; ++j)
                            object.entry[j] = $root.perfetto.protos.TransactionTraceEntry.toObject(message.entry[j], options);
                    }
                    if (message.realToElapsedTimeOffsetNanos != null && message.hasOwnProperty("realToElapsedTimeOffsetNanos"))
                ...
                TransactionTraceFile.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/perfetto.protos.TransactionTraceFile";
                };
    
                /**
                 * MagicNumber enum.
                 * @name perfetto.protos.TransactionTraceFile.MagicNumber
                 * @enum {number}
            ...
            protos.TransactionTraceEntry = (function() {
                 ...
                 * @property {Array.<perfetto.protos.ITransactionState>|null} [transactions] TransactionTraceEntry transactions
                 * @property {Array.<perfetto.protos.ILayerCreationArgs>|null} [addedLayers] TransactionTraceEntry addedLayers
                 * @property {Array.<number>|null} [destroyedLayers] TransactionTraceEntry destroyedLayers
                 * @property {Array.<perfetto.protos.IDisplayState>|null} [addedDisplays] TransactionTraceEntry addedDisplays
                 ...
                 * @property {Array.<perfetto.protos.IDisplayInfo>|null} [displays] TransactionTraceEntry displays
                 */
                 ...
                 * @constructor
                 * @param {perfetto.protos.ITransactionTraceEntry=} [properties] Properties to set
                 */
                 ...
                 * @memberof perfetto.protos.TransactionTraceEntry
                 * @instance
                 */
                 ...
                 * @member {Array.<perfetto.protos.ITransactionState>} transactions
                 * @memberof perfetto.protos.TransactionTraceEntry
                 * @instance
                 */
                 ...
                 * @member {Array.<perfetto.protos.ILayerCreationArgs>} addedLayers
                 * @memberof perfetto.protos.TransactionTraceEntry
                 * @instance
                 */
                 ...
                 * @member {Array.<perfetto.protos.IDisplayState>} addedDisplays
                 * @memberof perfetto.protos.TransactionTraceEntry
                 * @instance
                 */
                 ...
                 * @member {Array.<perfetto.protos.IDisplayInfo>} displays
                 * @memberof perfetto.protos.TransactionTraceEntry
                 * @instance
                 */
                 ...
                 * @static
                 * @param {perfetto.protos.ITransactionTraceEntry=} [properties] Properties to set
                 * @returns {perfetto.protos.TransactionTraceEntry} TransactionTraceEntry instance
                 */
                ...
                /**
                 * Encodes the specified TransactionTraceEntry message. Does not implicitly {@link perfetto.protos.TransactionTraceEntry.verify|verify} messages.
                 * @function encode
                 * @memberof perfetto.protos.TransactionTraceEntry
                 * @static
                 * @param {perfetto.protos.ITransactionTraceEntry} message TransactionTraceEntry message or plain object to encode
                 * @param {$protobuf.Writer} [writer] Writer to encode to
                 * @returns {$protobuf.Writer} Writer
                 */
                TransactionTraceEntry.encode = function encode(message, writer) {
                    ...
                    if (message.transactions != null && message.transactions.length)
                        for (var i = 0; i < message.transactions.length; ++i)
                            $root.perfetto.protos.TransactionState.encode(message.transactions[i], writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                    if (message.addedLayers != null && message.addedLayers.length)
                        for (var i = 0; i < message.addedLayers.length; ++i)
                            $root.perfetto.protos.LayerCreationArgs.encode(message.addedLayers[i], writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
                    if (message.destroyedLayers != null && message.destroyedLayers.length)
                        for (var i = 0; i < message.destroyedLayers.length; ++i)
                            writer.uint32(/* id 5, wireType 0 =*/40).uint32(message.destroyedLayers[i]);
                    if (message.addedDisplays != null && message.addedDisplays.length)
                        for (var i = 0; i < message.addedDisplays.length; ++i)
                            $root.perfetto.protos.DisplayState.encode(message.addedDisplays[i], writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
                    if (message.removedDisplays != null && message.removedDisplays.length)
                        for (var i = 0; i < message.removedDisplays.length; ++i)
                            writer.uint32(/* id 7, wireType 0 =*/56).int32(message.removedDisplays[i]);
                    if (message.destroyedLayerHandles != null && message.destroyedLayerHandles.length)
                        for (var i = 0; i < message.destroyedLayerHandles.length; ++i)
                            writer.uint32(/* id 8, wireType 0 =*/64).uint32(message.destroyedLayerHandles[i]);
                    ...
                    if (message.displays != null && message.displays.length)
                        for (var i = 0; i < message.displays.length; ++i)
                            $root.perfetto.protos.DisplayInfo.encode(message.displays[i], writer.uint32(/* id 10, wireType 2 =*/82).fork()).ldelim();
                    return writer;
                };
    
                /**
                 * Encodes the specified TransactionTraceEntry message, length delimited. Does not implicitly {@link perfetto.protos.TransactionTraceEntry.verify|verify} messages.
                 * @function encodeDelimited
                 * @memberof perfetto.protos.TransactionTraceEntry
                 * @static
                 * @param {perfetto.protos.ITransactionTraceEntry} message TransactionTraceEntry message or plain object to encode
                 ...
                 * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                 * @param {number} [length] Message length if known beforehand
                 * @returns {perfetto.protos.TransactionTraceEntry} TransactionTraceEntry
                 * @throws {Error} If the payload is not a reader or valid buffer
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                TransactionTraceEntry.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.perfetto.protos.TransactionTraceEntry();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                        ...
                        case 3: {
                                ...
                                message.transactions.push($root.perfetto.protos.TransactionState.decode(reader, reader.uint32()));
                                break;
                            }
                        case 4: {
                                if (!(message.addedLayers && message.addedLayers.length))
                                    message.addedLayers = [];
                                message.addedLayers.push($root.perfetto.protos.LayerCreationArgs.decode(reader, reader.uint32()));
                                break;
                            }
                        case 5: {
                        ...
                        case 6: {
                                ...
                                message.addedDisplays.push($root.perfetto.protos.DisplayState.decode(reader, reader.uint32()));
                                break;
                            }
                        case 7: {
                        ...
                        case 10: {
                                if (!(message.displays && message.displays.length))
                                    message.displays = [];
                                message.displays.push($root.perfetto.protos.DisplayInfo.decode(reader, reader.uint32()));
                                break;
                            }
                        default:
                            reader.skipType(tag & 7);
                ...
                TransactionTraceEntry.verify = function verify(message) {
                    ...
                    if (message.transactions != null && message.hasOwnProperty("transactions")) {
                        ...
                        for (var i = 0; i < message.transactions.length; ++i) {
                            var error = $root.perfetto.protos.TransactionState.verify(message.transactions[i]);
                            if (error)
                    ...
                    if (message.addedLayers != null && message.hasOwnProperty("addedLayers")) {
                        ...
                        for (var i = 0; i < message.addedLayers.length; ++i) {
                            var error = $root.perfetto.protos.LayerCreationArgs.verify(message.addedLayers[i]);
                            if (error)
                    ...
                    if (message.addedDisplays != null && message.hasOwnProperty("addedDisplays")) {
                        ...
                        for (var i = 0; i < message.addedDisplays.length; ++i) {
                            var error = $root.perfetto.protos.DisplayState.verify(message.addedDisplays[i]);
                            if (error)
                    ...
                    if (message.displays != null && message.hasOwnProperty("displays")) {
                        ...
                        for (var i = 0; i < message.displays.length; ++i) {
                            var error = $root.perfetto.protos.DisplayInfo.verify(message.displays[i]);
                            if (error)
                ...
                TransactionTraceEntry.fromObject = function fromObject(object) {
                    if (object instanceof $root.perfetto.protos.TransactionTraceEntry)
                        return object;
                    var message = new $root.perfetto.protos.TransactionTraceEntry();
                    ...
                    if (object.transactions) {
                        if (!Array.isArray(object.transactions))
                            throw TypeError(".perfetto.protos.TransactionTraceEntry.transactions: array expected");
                        message.transactions = [];
                        for (var i = 0; i < object.transactions.length; ++i) {
                            if (typeof object.transactions[i] !== "object")
                                throw TypeError(".perfetto.protos.TransactionTraceEntry.transactions: object expected");
                            message.transactions[i] = $root.perfetto.protos.TransactionState.fromObject(object.transactions[i]);
                        }
                    }
                    if (object.addedLayers) {
                        if (!Array.isArray(object.addedLayers))
                            throw TypeError(".perfetto.protos.TransactionTraceEntry.addedLayers: array expected");
                        message.addedLayers = [];
                        for (var i = 0; i < object.addedLayers.length; ++i) {
                            if (typeof object.addedLayers[i] !== "object")
                                throw TypeError(".perfetto.protos.TransactionTraceEntry.addedLayers: object expected");
                            message.addedLayers[i] = $root.perfetto.protos.LayerCreationArgs.fromObject(object.addedLayers[i]);
                        }
                    }
                    if (object.destroyedLayers) {
                        if (!Array.isArray(object.destroyedLayers))
                            throw TypeError(".perfetto.protos.TransactionTraceEntry.destroyedLayers: array expected");
                        message.destroyedLayers = [];
                    ...
                    if (object.addedDisplays) {
                        if (!Array.isArray(object.addedDisplays))
                            throw TypeError(".perfetto.protos.TransactionTraceEntry.addedDisplays: array expected");
                        message.addedDisplays = [];
                        for (var i = 0; i < object.addedDisplays.length; ++i) {
                            if (typeof object.addedDisplays[i] !== "object")
                                throw TypeError(".perfetto.protos.TransactionTraceEntry.addedDisplays: object expected");
                            message.addedDisplays[i] = $root.perfetto.protos.DisplayState.fromObject(object.addedDisplays[i]);
                        }
                    }
                    if (object.removedDisplays) {
                        if (!Array.isArray(object.removedDisplays))
                            throw TypeError(".perfetto.protos.TransactionTraceEntry.removedDisplays: array expected");
                        message.removedDisplays = [];
                    ...
                    if (object.destroyedLayerHandles) {
                        if (!Array.isArray(object.destroyedLayerHandles))
                            throw TypeError(".perfetto.protos.TransactionTraceEntry.destroyedLayerHandles: array expected");
                        message.destroyedLayerHandles = [];
                    ...
                    if (object.displays) {
                        if (!Array.isArray(object.displays))
                            throw TypeError(".perfetto.protos.TransactionTraceEntry.displays: array expected");
                        message.displays = [];
                        for (var i = 0; i < object.displays.length; ++i) {
                            if (typeof object.displays[i] !== "object")
                                throw TypeError(".perfetto.protos.TransactionTraceEntry.displays: object expected");
                            message.displays[i] = $root.perfetto.protos.DisplayInfo.fromObject(object.displays[i]);
                        }
                    }
                    return message;
                };
                 ...
                 * @memberof perfetto.protos.TransactionTraceEntry
                 * @static
                 * @param {perfetto.protos.TransactionTraceEntry} message TransactionTraceEntry
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                TransactionTraceEntry.toObject = function toObject(message, options) {
                    ...
                    if (message.transactions && message.transactions.length) {
                        ...
                        for (var j = 0; j < message.transactions.length; ++j)
                            object.transactions[j] = $root.perfetto.protos.TransactionState.toObject(message.transactions[j], options);
                    }
                    if (message.addedLayers && message.addedLayers.length) {
                        object.addedLayers = [];
                        for (var j = 0; j < message.addedLayers.length; ++j)
                            object.addedLayers[j] = $root.perfetto.protos.LayerCreationArgs.toObject(message.addedLayers[j], options);
                    }
                    if (message.destroyedLayers && message.destroyedLayers.length) {
                        object.destroyedLayers = [];
                    ...
                    if (message.addedDisplays && message.addedDisplays.length) {
                        ...
                        for (var j = 0; j < message.addedDisplays.length; ++j)
                            object.addedDisplays[j] = $root.perfetto.protos.DisplayState.toObject(message.addedDisplays[j], options);
                    }
                    if (message.removedDisplays && message.removedDisplays.length) {
                        object.removedDisplays = [];
                    ...
                    if (message.displays && message.displays.length) {
                        ...
                        for (var j = 0; j < message.displays.length; ++j)
                            object.displays[j] = $root.perfetto.protos.DisplayInfo.toObject(message.displays[j], options);
                    }
                    return object;
                };
                ...
                TransactionTraceEntry.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/perfetto.protos.TransactionTraceEntry";
                };
    
                return TransactionTraceEntry;
            })();
    
            protos.DisplayInfo = (function() {
                 ...
                 * @property {perfetto.protos.ITransform|null} [transformInverse] DisplayInfo transformInverse
                 * @property {perfetto.protos.ITransform|null} [transform] DisplayInfo transform
                 ...
                 * @constructor
                 * @param {perfetto.protos.IDisplayInfo=} [properties] Properties to set
                 */
                 ...
                 * @memberof perfetto.protos.DisplayInfo
                 * @instance
                 */
                 ...
                 * @member {perfetto.protos.ITransform|null|undefined} transformInverse
                 * @memberof perfetto.protos.DisplayInfo
                 * @instance
                 */
                 ...
                 * @member {perfetto.protos.ITransform|null|undefined} transform
                 * @memberof perfetto.protos.DisplayInfo
                 * @instance
                 */
                 ...
                 * @static
                 * @param {perfetto.protos.IDisplayInfo=} [properties] Properties to set
                 * @returns {perfetto.protos.DisplayInfo} DisplayInfo instance
                 */
                ...
                /**
                 * Encodes the specified DisplayInfo message. Does not implicitly {@link perfetto.protos.DisplayInfo.verify|verify} messages.
                 * @function encode
                 * @memberof perfetto.protos.DisplayInfo
                 * @static
                 * @param {perfetto.protos.IDisplayInfo} message DisplayInfo message or plain object to encode
                 * @param {$protobuf.Writer} [writer] Writer to encode to
                 * @returns {$protobuf.Writer} Writer
                 */
                DisplayInfo.encode = function encode(message, writer) {
                    ...
                    if (message.transformInverse != null && Object.hasOwnProperty.call(message, "transformInverse"))
                        $root.perfetto.protos.Transform.encode(message.transformInverse, writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
                    if (message.transform != null && Object.hasOwnProperty.call(message, "transform"))
                        $root.perfetto.protos.Transform.encode(message.transform, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
                ...
                /**
                 * Encodes the specified DisplayInfo message, length delimited. Does not implicitly {@link perfetto.protos.DisplayInfo.verify|verify} messages.
                 * @function encodeDelimited
                 * @memberof perfetto.protos.DisplayInfo
                 * @static
                 * @param {perfetto.protos.IDisplayInfo} message DisplayInfo message or plain object to encode
                 ...
                 * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                 * @param {number} [length] Message length if known beforehand
                 * @returns {perfetto.protos.DisplayInfo} DisplayInfo
                 * @throws {Error} If the payload is not a reader or valid buffer
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                DisplayInfo.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.perfetto.protos.DisplayInfo();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                        ...
                        case 5: {
                                message.transformInverse = $root.perfetto.protos.Transform.decode(reader, reader.uint32());
                                break;
                            }
                        case 6: {
                                message.transform = $root.perfetto.protos.Transform.decode(reader, reader.uint32());
                                break;
                            }
                        case 7: {
                ...
                DisplayInfo.verify = function verify(message) {
                    ...
                    if (message.transformInverse != null && message.hasOwnProperty("transformInverse")) {
                        var error = $root.perfetto.protos.Transform.verify(message.transformInverse);
                        if (error)
                            return "transformInverse." + error;
                    }
                    if (message.transform != null && message.hasOwnProperty("transform")) {
                        var error = $root.perfetto.protos.Transform.verify(message.transform);
                        if (error)
                ...
                DisplayInfo.fromObject = function fromObject(object) {
                    if (object instanceof $root.perfetto.protos.DisplayInfo)
                        return object;
                    var message = new $root.perfetto.protos.DisplayInfo();
                    ...
                    if (object.transformInverse != null) {
                        if (typeof object.transformInverse !== "object")
                            throw TypeError(".perfetto.protos.DisplayInfo.transformInverse: object expected");
                        message.transformInverse = $root.perfetto.protos.Transform.fromObject(object.transformInverse);
                    }
                    if (object.transform != null) {
                        if (typeof object.transform !== "object")
                            throw TypeError(".perfetto.protos.DisplayInfo.transform: object expected");
                        message.transform = $root.perfetto.protos.Transform.fromObject(object.transform);
                    }
                 ...
                 * @memberof perfetto.protos.DisplayInfo
                 * @static
                 * @param {perfetto.protos.DisplayInfo} message DisplayInfo
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                DisplayInfo.toObject = function toObject(message, options) {
                    ...
                    if (message.transformInverse != null && message.hasOwnProperty("transformInverse"))
                        object.transformInverse = $root.perfetto.protos.Transform.toObject(message.transformInverse, options);
                    if (message.transform != null && message.hasOwnProperty("transform"))
                        object.transform = $root.perfetto.protos.Transform.toObject(message.transform, options);
                    if (message.receivesInput != null && message.hasOwnProperty("receivesInput"))
                ...
                DisplayInfo.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/perfetto.protos.DisplayInfo";
                };
    
                return DisplayInfo;
            })();
    
            protos.LayerCreationArgs = (function() {
                 ...
                 * @constructor
                 * @param {perfetto.protos.ILayerCreationArgs=} [properties] Properties to set
                 */
                 ...
                 * @memberof perfetto.protos.LayerCreationArgs
                 * @instance
                 */
                 ...
                 * @static
                 * @param {perfetto.protos.ILayerCreationArgs=} [properties] Properties to set
                 * @returns {perfetto.protos.LayerCreationArgs} LayerCreationArgs instance
                 */
                ...
                /**
                 * Encodes the specified LayerCreationArgs message. Does not implicitly {@link perfetto.protos.LayerCreationArgs.verify|verify} messages.
                 * @function encode
                 * @memberof perfetto.protos.LayerCreationArgs
                 * @static
                 * @param {perfetto.protos.ILayerCreationArgs} message LayerCreationArgs message or plain object to encode
                 * @param {$protobuf.Writer} [writer] Writer to encode to
                 * @returns {$protobuf.Writer} Writer
                 */
                ...
                /**
                 * Encodes the specified LayerCreationArgs message, length delimited. Does not implicitly {@link perfetto.protos.LayerCreationArgs.verify|verify} messages.
                 * @function encodeDelimited
                 * @memberof perfetto.protos.LayerCreationArgs
                 * @static
                 * @param {perfetto.protos.ILayerCreationArgs} message LayerCreationArgs message or plain object to encode
                 ...
                 * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                 * @param {number} [length] Message length if known beforehand
                 * @returns {perfetto.protos.LayerCreationArgs} LayerCreationArgs
                 * @throws {Error} If the payload is not a reader or valid buffer
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                LayerCreationArgs.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.perfetto.protos.LayerCreationArgs();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                ...
                LayerCreationArgs.fromObject = function fromObject(object) {
                    if (object instanceof $root.perfetto.protos.LayerCreationArgs)
                        return object;
                    var message = new $root.perfetto.protos.LayerCreationArgs();
                 ...
                 * @memberof perfetto.protos.LayerCreationArgs
                 * @static
                 * @param {perfetto.protos.LayerCreationArgs} message LayerCreationArgs
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                ...
                LayerCreationArgs.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/perfetto.protos.LayerCreationArgs";
                };
    
                return LayerCreationArgs;
            })();
    
            protos.Transform = (function() {
                 ...
                 * @constructor
                 * @param {perfetto.protos.ITransform=} [properties] Properties to set
                 */
                 ...
                 * Transform dsdx.
                 * @member {number} dsdx
                 * @memberof perfetto.protos.Transform
                 * @instance
                 */
                 ...
                 * @static
                 * @param {perfetto.protos.ITransform=} [properties] Properties to set
                 * @returns {perfetto.protos.Transform} Transform instance
                 */
                ...
                /**
                 * Encodes the specified Transform message. Does not implicitly {@link perfetto.protos.Transform.verify|verify} messages.
                 * @function encode
                 * @memberof perfetto.protos.Transform
                 * @static
                 * @param {perfetto.protos.ITransform} message Transform message or plain object to encode
                 * @param {$protobuf.Writer} [writer] Writer to encode to
                 * @returns {$protobuf.Writer} Writer
                 */
                ...
                /**
                 * Encodes the specified Transform message, length delimited. Does not implicitly {@link perfetto.protos.Transform.verify|verify} messages.
                 * @function encodeDelimited
                 * @memberof perfetto.protos.Transform
                 * @static
                 * @param {perfetto.protos.ITransform} message Transform message or plain object to encode
                 ...
                 * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                 * @param {number} [length] Message length if known beforehand
                 * @returns {perfetto.protos.Transform} Transform
                 * @throws {Error} If the payload is not a reader or valid buffer
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                Transform.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.perfetto.protos.Transform();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                ...
                Transform.fromObject = function fromObject(object) {
                    if (object instanceof $root.perfetto.protos.Transform)
                        return object;
                    var message = new $root.perfetto.protos.Transform();
                    if (object.dsdx != null)
                 ...
                 * @memberof perfetto.protos.Transform
                 * @static
                 * @param {perfetto.protos.Transform} message Transform
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                ...
                Transform.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/perfetto.protos.Transform";
                };
    
                return Transform;
            })();
    
            protos.TransactionState = (function() {
                 ...
                 * @property {Array.<perfetto.protos.ILayerState>|null} [layerChanges] TransactionState layerChanges
                 * @property {Array.<perfetto.protos.IDisplayState>|null} [displayChanges] TransactionState displayChanges
                 ...
                 * @constructor
                 * @param {perfetto.protos.ITransactionState=} [properties] Properties to set
                 */
                 ...
                 * @member {number} pid
                 * @memberof perfetto.protos.TransactionState
                 * @instance
                 */
                 ...
                 * @member {Array.<perfetto.protos.ILayerState>} layerChanges
                 * @memberof perfetto.protos.TransactionState
                 * @instance
                 */
                 ...
                 * @member {Array.<perfetto.protos.IDisplayState>} displayChanges
                 * @memberof perfetto.protos.TransactionState
                 * @instance
                 */
                 ...
                 * @static
                 * @param {perfetto.protos.ITransactionState=} [properties] Properties to set
                 * @returns {perfetto.protos.TransactionState} TransactionState instance
                 */
                ...
                /**
                 * Encodes the specified TransactionState message. Does not implicitly {@link perfetto.protos.TransactionState.verify|verify} messages.
                 * @function encode
                 * @memberof perfetto.protos.TransactionState
                 * @static
                 * @param {perfetto.protos.ITransactionState} message TransactionState message or plain object to encode
                 * @param {$protobuf.Writer} [writer] Writer to encode to
                 * @returns {$protobuf.Writer} Writer
                 */
                TransactionState.encode = function encode(message, writer) {
                    ...
                    if (message.layerChanges != null && message.layerChanges.length)
                        for (var i = 0; i < message.layerChanges.length; ++i)
                            $root.perfetto.protos.LayerState.encode(message.layerChanges[i], writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
                    if (message.displayChanges != null && message.displayChanges.length)
                        for (var i = 0; i < message.displayChanges.length; ++i)
                            $root.perfetto.protos.DisplayState.encode(message.displayChanges[i], writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
                    if (message.mergedTransactionIds != null && message.mergedTransactionIds.length)
                        for (var i = 0; i < message.mergedTransactionIds.length; ++i)
                            writer.uint32(/* id 9, wireType 0 =*/72).uint64(message.mergedTransactionIds[i]);
                    return writer;
                };
    
                /**
                 * Encodes the specified TransactionState message, length delimited. Does not implicitly {@link perfetto.protos.TransactionState.verify|verify} messages.
                 * @function encodeDelimited
                 * @memberof perfetto.protos.TransactionState
                 * @static
                 * @param {perfetto.protos.ITransactionState} message TransactionState message or plain object to encode
                 ...
                 * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                 * @param {number} [length] Message length if known beforehand
                 * @returns {perfetto.protos.TransactionState} TransactionState
                 * @throws {Error} If the payload is not a reader or valid buffer
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                TransactionState.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.perfetto.protos.TransactionState();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                        ...
                        case 7: {
                                ...
                                message.layerChanges.push($root.perfetto.protos.LayerState.decode(reader, reader.uint32()));
                                break;
                            }
                        case 8: {
                                if (!(message.displayChanges && message.displayChanges.length))
                                    message.displayChanges = [];
                                message.displayChanges.push($root.perfetto.protos.DisplayState.decode(reader, reader.uint32()));
                                break;
                            }
                        case 9: {
                ...
                TransactionState.verify = function verify(message) {
                    ...
                    if (message.layerChanges != null && message.hasOwnProperty("layerChanges")) {
                        ...
                        for (var i = 0; i < message.layerChanges.length; ++i) {
                            var error = $root.perfetto.protos.LayerState.verify(message.layerChanges[i]);
                            if (error)
                    ...
                    if (message.displayChanges != null && message.hasOwnProperty("displayChanges")) {
                        ...
                        for (var i = 0; i < message.displayChanges.length; ++i) {
                            var error = $root.perfetto.protos.DisplayState.verify(message.displayChanges[i]);
                            if (error)
                ...
                TransactionState.fromObject = function fromObject(object) {
                    if (object instanceof $root.perfetto.protos.TransactionState)
                        return object;
                    var message = new $root.perfetto.protos.TransactionState();
                    if (object.pid != null)
                    ...
                    if (object.layerChanges) {
                        if (!Array.isArray(object.layerChanges))
                            throw TypeError(".perfetto.protos.TransactionState.layerChanges: array expected");
                        message.layerChanges = [];
                        for (var i = 0; i < object.layerChanges.length; ++i) {
                            if (typeof object.layerChanges[i] !== "object")
                                throw TypeError(".perfetto.protos.TransactionState.layerChanges: object expected");
                            message.layerChanges[i] = $root.perfetto.protos.LayerState.fromObject(object.layerChanges[i]);
                        }
                    }
                    if (object.displayChanges) {
                        if (!Array.isArray(object.displayChanges))
                            throw TypeError(".perfetto.protos.TransactionState.displayChanges: array expected");
                        message.displayChanges = [];
                        for (var i = 0; i < object.displayChanges.length; ++i) {
                            if (typeof object.displayChanges[i] !== "object")
                                throw TypeError(".perfetto.protos.TransactionState.displayChanges: object expected");
                            message.displayChanges[i] = $root.perfetto.protos.DisplayState.fromObject(object.displayChanges[i]);
                        }
                    }
                    if (object.mergedTransactionIds) {
                        if (!Array.isArray(object.mergedTransactionIds))
                            throw TypeError(".perfetto.protos.TransactionState.mergedTransactionIds: array expected");
                        message.mergedTransactionIds = [];
                 ...
                 * @memberof perfetto.protos.TransactionState
                 * @static
                 * @param {perfetto.protos.TransactionState} message TransactionState
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                TransactionState.toObject = function toObject(message, options) {
                    ...
                    if (message.layerChanges && message.layerChanges.length) {
                        ...
                        for (var j = 0; j < message.layerChanges.length; ++j)
                            object.layerChanges[j] = $root.perfetto.protos.LayerState.toObject(message.layerChanges[j], options);
                    }
                    if (message.displayChanges && message.displayChanges.length) {
                        object.displayChanges = [];
                        for (var j = 0; j < message.displayChanges.length; ++j)
                            object.displayChanges[j] = $root.perfetto.protos.DisplayState.toObject(message.displayChanges[j], options);
                    }
                    if (message.mergedTransactionIds && message.mergedTransactionIds.length) {
                        object.mergedTransactionIds = [];
                ...
                TransactionState.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/perfetto.protos.TransactionState";
                };
    
                return TransactionState;
            })();
    
            protos.LayerState = (function() {
                 ...
                 * @property {perfetto.protos.LayerState.IMatrix22|null} [matrix] LayerState matrix
                 ...
                 * @property {perfetto.protos.LayerState.IColor3|null} [color] LayerState color
                 * @property {perfetto.protos.IRegionProto|null} [transparentRegion] LayerState transparentRegion
                 ...
                 * @property {perfetto.protos.IRectProto|null} [crop] LayerState crop
                 * @property {perfetto.protos.LayerState.IBufferData|null} [bufferData] LayerState bufferData
                 * @property {number|null} [api] LayerState api
                 * @property {boolean|null} [hasSidebandStream] LayerState hasSidebandStream
                 * @property {perfetto.protos.IColorTransformProto|null} [colorTransform] LayerState colorTransform
                 * @property {Array.<perfetto.protos.IBlurRegion>|null} [blurRegions] LayerState blurRegions
                 * @property {perfetto.protos.LayerState.IWindowInfo|null} [windowInfoHandle] LayerState windowInfoHandle
                 ...
                 * @property {perfetto.protos.IRectProto|null} [bufferCrop] LayerState bufferCrop
                 * @property {perfetto.protos.IRectProto|null} [destinationFrame] LayerState destinationFrame
                 * @property {perfetto.protos.LayerState.DropInputMode|null} [dropInputMode] LayerState dropInputMode
                 * @property {perfetto.protos.TrustedOverlay|null} [trustedOverlay] LayerState trustedOverlay
                 */
                 ...
                 * @constructor
                 * @param {perfetto.protos.ILayerState=} [properties] Properties to set
                 */
                 ...
                 * LayerState layerId.
                 * @member {number} layerId
                 * @memberof perfetto.protos.LayerState
                 * @instance
                 */
                ...
                /**
                 * LayerState matrix.
                 * @member {perfetto.protos.LayerState.IMatrix22|null|undefined} matrix
                 * @memberof perfetto.protos.LayerState
                 * @instance
                 */
                ...
                /**
                 * LayerState color.
                 * @member {perfetto.protos.LayerState.IColor3|null|undefined} color
                 * @memberof perfetto.protos.LayerState
                 * @instance
                 */
                 ...
                 * @member {perfetto.protos.LayerState.IBufferData|null|undefined} bufferData
                 * @memberof perfetto.protos.LayerState
                 * @instance
                 */
                 ...
                 * @member {perfetto.protos.LayerState.IWindowInfo|null|undefined} windowInfoHandle
                 * @memberof perfetto.protos.LayerState
                 * @instance
                 */
                 ...
                 * @member {perfetto.protos.IRectProto|null|undefined} bufferCrop
                 * @memberof perfetto.protos.LayerState
                 * @instance
                 */
                 ...
                 * @member {perfetto.protos.LayerState.DropInputMode} dropInputMode
                 * @memberof perfetto.protos.LayerState
                 * @instance
                 */
                ...
                /**
                 * LayerState trustedOverlay.
                 * @member {perfetto.protos.TrustedOverlay} trustedOverlay
                 * @memberof perfetto.protos.LayerState
                 * @instance
                 */
                LayerState.prototype.trustedOverlay = 0;
                 ...
                 * @static
                 * @param {perfetto.protos.ILayerState=} [properties] Properties to set
                 * @returns {perfetto.protos.LayerState} LayerState instance
                 */
                ...
                /**
                 * Encodes the specified LayerState message. Does not implicitly {@link perfetto.protos.LayerState.verify|verify} messages.
                 * @function encode
                 * @memberof perfetto.protos.LayerState
                 * @static
                 * @param {perfetto.protos.ILayerState} message LayerState message or plain object to encode
                 * @param {$protobuf.Writer} [writer] Writer to encode to
                 * @returns {$protobuf.Writer} Writer
                 */
                LayerState.encode = function encode(message, writer) {
                    ...
                    if (message.matrix != null && Object.hasOwnProperty.call(message, "matrix"))
                        $root.perfetto.protos.LayerState.Matrix22.encode(message.matrix, writer.uint32(/* id 11, wireType 2 =*/90).fork()).ldelim();
                    ...
                    if (message.color != null && Object.hasOwnProperty.call(message, "color"))
                        $root.perfetto.protos.LayerState.Color3.encode(message.color, writer.uint32(/* id 17, wireType 2 =*/138).fork()).ldelim();
                    if (message.transparentRegion != null && Object.hasOwnProperty.call(message, "transparentRegion"))
                        $root.perfetto.protos.RegionProto.encode(message.transparentRegion, writer.uint32(/* id 18, wireType 2 =*/146).fork()).ldelim();
                    if (message.transform != null && Object.hasOwnProperty.call(message, "transform"))
                    ...
                    if (message.crop != null && Object.hasOwnProperty.call(message, "crop"))
                        $root.perfetto.protos.RectProto.encode(message.crop, writer.uint32(/* id 21, wireType 2 =*/170).fork()).ldelim();
                    if (message.bufferData != null && Object.hasOwnProperty.call(message, "bufferData"))
                        $root.perfetto.protos.LayerState.BufferData.encode(message.bufferData, writer.uint32(/* id 22, wireType 2 =*/178).fork()).ldelim();
                    ...
                    if (message.colorTransform != null && Object.hasOwnProperty.call(message, "colorTransform"))
                        $root.perfetto.protos.ColorTransformProto.encode(message.colorTransform, writer.uint32(/* id 25, wireType 2 =*/202).fork()).ldelim();
                    if (message.blurRegions != null && message.blurRegions.length)
                        for (var i = 0; i < message.blurRegions.length; ++i)
                            $root.perfetto.protos.BlurRegion.encode(message.blurRegions[i], writer.uint32(/* id 26, wireType 2 =*/210).fork()).ldelim();
                    if (message.windowInfoHandle != null && Object.hasOwnProperty.call(message, "windowInfoHandle"))
                        $root.perfetto.protos.LayerState.WindowInfo.encode(message.windowInfoHandle, writer.uint32(/* id 27, wireType 2 =*/218).fork()).ldelim();
                    ...
                    if (message.bufferCrop != null && Object.hasOwnProperty.call(message, "bufferCrop"))
                        $root.perfetto.protos.RectProto.encode(message.bufferCrop, writer.uint32(/* id 40, wireType 2 =*/322).fork()).ldelim();
                    if (message.destinationFrame != null && Object.hasOwnProperty.call(message, "destinationFrame"))
                        $root.perfetto.protos.RectProto.encode(message.destinationFrame, writer.uint32(/* id 41, wireType 2 =*/330).fork()).ldelim();
                    ...
                    if (message.trustedOverlay != null && Object.hasOwnProperty.call(message, "trustedOverlay"))
                        writer.uint32(/* id 43, wireType 0 =*/344).int32(message.trustedOverlay);
                    return writer;
                };
    
                /**
                 * Encodes the specified LayerState message, length delimited. Does not implicitly {@link perfetto.protos.LayerState.verify|verify} messages.
                 * @function encodeDelimited
                 * @memberof perfetto.protos.LayerState
                 * @static
                 * @param {perfetto.protos.ILayerState} message LayerState message or plain object to encode
                 ...
                 * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                 * @param {number} [length] Message length if known beforehand
                 * @returns {perfetto.protos.LayerState} LayerState
                 * @throws {Error} If the payload is not a reader or valid buffer
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                LayerState.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.perfetto.protos.LayerState();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                        ...
                        case 11: {
                                message.matrix = $root.perfetto.protos.LayerState.Matrix22.decode(reader, reader.uint32());
                                break;
                            }
                        case 12: {
                        ...
                        case 17: {
                                message.color = $root.perfetto.protos.LayerState.Color3.decode(reader, reader.uint32());
                                break;
                            }
                        case 18: {
                        ...
                        case 22: {
                                message.bufferData = $root.perfetto.protos.LayerState.BufferData.decode(reader, reader.uint32());
                                break;
                            }
                        case 23: {
                        ...
                        case 27: {
                                message.windowInfoHandle = $root.perfetto.protos.LayerState.WindowInfo.decode(reader, reader.uint32());
                                break;
                            }
                        case 28: {
                        ...
                        case 40: {
                                message.bufferCrop = $root.perfetto.protos.RectProto.decode(reader, reader.uint32());
                                break;
                            }
                        case 41: {
                ...
                LayerState.verify = function verify(message) {
                    ...
                    if (message.matrix != null && message.hasOwnProperty("matrix")) {
                        var error = $root.perfetto.protos.LayerState.Matrix22.verify(message.matrix);
                        if (error)
                            return "matrix." + error;
                    }
                    ...
                    if (message.color != null && message.hasOwnProperty("color")) {
                        var error = $root.perfetto.protos.LayerState.Color3.verify(message.color);
                        if (error)
                            return "color." + error;
                    }
                    ...
                    if (message.bufferData != null && message.hasOwnProperty("bufferData")) {
                        var error = $root.perfetto.protos.LayerState.BufferData.verify(message.bufferData);
                        if (error)
                    ...
                    if (message.windowInfoHandle != null && message.hasOwnProperty("windowInfoHandle")) {
                        var error = $root.perfetto.protos.LayerState.WindowInfo.verify(message.windowInfoHandle);
                        if (error)
                    ...
                    if (message.bufferCrop != null && message.hasOwnProperty("bufferCrop")) {
                        var error = $root.perfetto.protos.RectProto.verify(message.bufferCrop);
                        if (error)
                ...
                LayerState.fromObject = function fromObject(object) {
                    if (object instanceof $root.perfetto.protos.LayerState)
                        return object;
                    var message = new $root.perfetto.protos.LayerState();
                    if (object.layerId != null)
                        message.layerId = object.layerId >>> 0;
                    if (object.what != null)
                        if ($util.Long)
                    ...
                    if (object.matrix != null) {
                        if (typeof object.matrix !== "object")
                            throw TypeError(".perfetto.protos.LayerState.matrix: object expected");
                        message.matrix = $root.perfetto.protos.LayerState.Matrix22.fromObject(object.matrix);
                    }
                    ...
                    if (object.color != null) {
                        if (typeof object.color !== "object")
                            throw TypeError(".perfetto.protos.LayerState.color: object expected");
                        message.color = $root.perfetto.protos.LayerState.Color3.fromObject(object.color);
                    }
                    if (object.transparentRegion != null) {
                        if (typeof object.transparentRegion !== "object")
                            throw TypeError(".perfetto.protos.LayerState.transparentRegion: object expected");
                    ...
                    if (object.crop != null) {
                        if (typeof object.crop !== "object")
                            throw TypeError(".perfetto.protos.LayerState.crop: object expected");
                    ...
                    if (object.bufferData != null) {
                        if (typeof object.bufferData !== "object")
                            throw TypeError(".perfetto.protos.LayerState.bufferData: object expected");
                        message.bufferData = $root.perfetto.protos.LayerState.BufferData.fromObject(object.bufferData);
                    }
                    if (object.api != null)
                    ...
                    if (object.colorTransform != null) {
                        if (typeof object.colorTransform !== "object")
                            throw TypeError(".perfetto.protos.LayerState.colorTransform: object expected");
                    ...
                    if (object.blurRegions) {
                        if (!Array.isArray(object.blurRegions))
                            throw TypeError(".perfetto.protos.LayerState.blurRegions: array expected");
                        message.blurRegions = [];
                        for (var i = 0; i < object.blurRegions.length; ++i) {
                            if (typeof object.blurRegions[i] !== "object")
                                throw TypeError(".perfetto.protos.LayerState.blurRegions: object expected");
                    ...
                    if (object.windowInfoHandle != null) {
                        if (typeof object.windowInfoHandle !== "object")
                            throw TypeError(".perfetto.protos.LayerState.windowInfoHandle: object expected");
                        message.windowInfoHandle = $root.perfetto.protos.LayerState.WindowInfo.fromObject(object.windowInfoHandle);
                    }
                    ...
                    if (object.bufferCrop != null) {
                        if (typeof object.bufferCrop !== "object")
                            throw TypeError(".perfetto.protos.LayerState.bufferCrop: object expected");
                        message.bufferCrop = $root.perfetto.protos.RectProto.fromObject(object.bufferCrop);
                    }
                    if (object.destinationFrame != null) {
                        if (typeof object.destinationFrame !== "object")
                            throw TypeError(".perfetto.protos.LayerState.destinationFrame: object expected");
                 ...
                 * @memberof perfetto.protos.LayerState
                 * @static
                 * @param {perfetto.protos.LayerState} message LayerState
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                LayerState.toObject = function toObject(message, options) {
                    ...
                    if (message.matrix != null && message.hasOwnProperty("matrix"))
                        object.matrix = $root.perfetto.protos.LayerState.Matrix22.toObject(message.matrix, options);
                    if (message.cornerRadius != null && message.hasOwnProperty("cornerRadius"))
                    ...
                    if (message.color != null && message.hasOwnProperty("color"))
                        object.color = $root.perfetto.protos.LayerState.Color3.toObject(message.color, options);
                    if (message.transparentRegion != null && message.hasOwnProperty("transparentRegion"))
                    ...
                    if (message.bufferData != null && message.hasOwnProperty("bufferData"))
                        object.bufferData = $root.perfetto.protos.LayerState.BufferData.toObject(message.bufferData, options);
                    if (message.api != null && message.hasOwnProperty("api"))
                    ...
                    if (message.windowInfoHandle != null && message.hasOwnProperty("windowInfoHandle"))
                        object.windowInfoHandle = $root.perfetto.protos.LayerState.WindowInfo.toObject(message.windowInfoHandle, options);
                    if (message.bgColorAlpha != null && message.hasOwnProperty("bgColorAlpha"))
                    ...
                    if (message.bufferCrop != null && message.hasOwnProperty("bufferCrop"))
                        object.bufferCrop = $root.perfetto.protos.RectProto.toObject(message.bufferCrop, options);
                    if (message.destinationFrame != null && message.hasOwnProperty("destinationFrame"))
                        object.destinationFrame = $root.perfetto.protos.RectProto.toObject(message.destinationFrame, options);
                    if (message.dropInputMode != null && message.hasOwnProperty("dropInputMode"))
                        object.dropInputMode = options.enums === String ? $root.perfetto.protos.LayerState.DropInputMode[message.dropInputMode] === undefined ? message.dropInputMode : $root.perfetto.protos.LayerState.DropInputMode[message.dropInputMode] : message.dropInputMode;
                    if (message.trustedOverlay != null && message.hasOwnProperty("trustedOverlay"))
                ...
                LayerState.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/perfetto.protos.LayerState";
                };
    
                /**
                 * ChangesLsb enum.
                 * @name perfetto.protos.LayerState.ChangesLsb
                 * @enum {number}
                ...
                /**
                 * ChangesMsb enum.
                 * @name perfetto.protos.LayerState.ChangesMsb
                 * @enum {number}
                ...
                /**
                 * Flags enum.
                 * @name perfetto.protos.LayerState.Flags
                 * @enum {number}
                ...
                LayerState.Matrix22 = (function() {
                     ...
                     * @constructor
                     * @param {perfetto.protos.LayerState.IMatrix22=} [properties] Properties to set
                     */
                     ...
                     * Matrix22 dsdx.
                     * @member {number} dsdx
                     * @memberof perfetto.protos.LayerState.Matrix22
                     * @instance
                     */
                     ...
                     * @static
                     * @param {perfetto.protos.LayerState.IMatrix22=} [properties] Properties to set
                     * @returns {perfetto.protos.LayerState.Matrix22} Matrix22 instance
                     */
                    ...
                    /**
                     * Encodes the specified Matrix22 message. Does not implicitly {@link perfetto.protos.LayerState.Matrix22.verify|verify} messages.
                     * @function encode
                     * @memberof perfetto.protos.LayerState.Matrix22
                     * @static
                     * @param {perfetto.protos.LayerState.IMatrix22} message Matrix22 message or plain object to encode
                     * @param {$protobuf.Writer} [writer] Writer to encode to
                     * @returns {$protobuf.Writer} Writer
                     */
                    ...
                    /**
                     * Encodes the specified Matrix22 message, length delimited. Does not implicitly {@link perfetto.protos.LayerState.Matrix22.verify|verify} messages.
                     * @function encodeDelimited
                     * @memberof perfetto.protos.LayerState.Matrix22
                     * @static
                     * @param {perfetto.protos.LayerState.IMatrix22} message Matrix22 message or plain object to encode
                     ...
                     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                     * @param {number} [length] Message length if known beforehand
                     * @returns {perfetto.protos.LayerState.Matrix22} Matrix22
                     * @throws {Error} If the payload is not a reader or valid buffer
                     * @throws {$protobuf.util.ProtocolError} If required fields are missing
                     */
                    Matrix22.decode = function decode(reader, length) {
                        if (!(reader instanceof $Reader))
                            reader = $Reader.create(reader);
                        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.perfetto.protos.LayerState.Matrix22();
                        while (reader.pos < end) {
                            var tag = reader.uint32();
                            switch (tag >>> 3) {
                            case 1: {
                    ...
                    Matrix22.fromObject = function fromObject(object) {
                        if (object instanceof $root.perfetto.protos.LayerState.Matrix22)
                            return object;
                        var message = new $root.perfetto.protos.LayerState.Matrix22();
                        if (object.dsdx != null)
                            message.dsdx = Number(object.dsdx);
                        if (object.dtdx != null)
                            message.dtdx = Number(object.dtdx);
                     ...
                     * @memberof perfetto.protos.LayerState.Matrix22
                     * @static
                     * @param {perfetto.protos.LayerState.Matrix22} message Matrix22
                     * @param {$protobuf.IConversionOptions} [options] Conversion options
                     * @returns {Object.<string,*>} Plain object
                     */
                    ...
                    Matrix22.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                        ...
                        return typeUrlPrefix + "/perfetto.protos.LayerState.Matrix22";
                    };
                ...
                LayerState.Color3 = (function() {
                     ...
                     * @implements IColor3
                     * @constructor
                     * @param {perfetto.protos.LayerState.IColor3=} [properties] Properties to set
                     */
                     ...
                     * Color3 r.
                     * @member {number} r
                     * @memberof perfetto.protos.LayerState.Color3
                     * @instance
                     */
                     ...
                     * @static
                     * @param {perfetto.protos.LayerState.IColor3=} [properties] Properties to set
                     * @returns {perfetto.protos.LayerState.Color3} Color3 instance
                     */
                    ...
                    /**
                     * Encodes the specified Color3 message. Does not implicitly {@link perfetto.protos.LayerState.Color3.verify|verify} messages.
                     * @function encode
                     * @memberof perfetto.protos.LayerState.Color3
                     * @static
                     * @param {perfetto.protos.LayerState.IColor3} message Color3 message or plain object to encode
                     * @param {$protobuf.Writer} [writer] Writer to encode to
                     * @returns {$protobuf.Writer} Writer
                     */
                    ...
                    /**
                     * Encodes the specified Color3 message, length delimited. Does not implicitly {@link perfetto.protos.LayerState.Color3.verify|verify} messages.
                     * @function encodeDelimited
                     * @memberof perfetto.protos.LayerState.Color3
                     * @static
                     * @param {perfetto.protos.LayerState.IColor3} message Color3 message or plain object to encode
                     ...
                     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                     * @param {number} [length] Message length if known beforehand
                     * @returns {perfetto.protos.LayerState.Color3} Color3
                     * @throws {Error} If the payload is not a reader or valid buffer
                     * @throws {$protobuf.util.ProtocolError} If required fields are missing
                     */
                    Color3.decode = function decode(reader, length) {
                        if (!(reader instanceof $Reader))
                            reader = $Reader.create(reader);
                        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.perfetto.protos.LayerState.Color3();
                        while (reader.pos < end) {
                            var tag = reader.uint32();
                            switch (tag >>> 3) {
                            case 1: {
                    ...
                    Color3.fromObject = function fromObject(object) {
                        if (object instanceof $root.perfetto.protos.LayerState.Color3)
                            return object;
                        var message = new $root.perfetto.protos.LayerState.Color3();
                        if (object.r != null)
                     ...
                     * @memberof perfetto.protos.LayerState.Color3
                     * @static
                     * @param {perfetto.protos.LayerState.Color3} message Color3
                     * @param {$protobuf.IConversionOptions} [options] Conversion options
                     * @returns {Object.<string,*>} Plain object
                     */
                    ...
                    Color3.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                        ...
                        return typeUrlPrefix + "/perfetto.protos.LayerState.Color3";
                    };
                ...
                LayerState.BufferData = (function() {
                     ...
                     * @property {perfetto.protos.LayerState.BufferData.PixelFormat|null} [pixelFormat] BufferData pixelFormat
                     ...
                     * @constructor
                     * @param {perfetto.protos.LayerState.IBufferData=} [properties] Properties to set
                     */
                     ...
                     * @memberof perfetto.protos.LayerState.BufferData
                     * @instance
                     */
                     ...
                     * @member {perfetto.protos.LayerState.BufferData.PixelFormat} pixelFormat
                     * @memberof perfetto.protos.LayerState.BufferData
                     * @instance
                     */
                     ...
                     * @static
                     * @param {perfetto.protos.LayerState.IBufferData=} [properties] Properties to set
                     * @returns {perfetto.protos.LayerState.BufferData} BufferData instance
                     */
                    ...
                    /**
                     * Encodes the specified BufferData message. Does not implicitly {@link perfetto.protos.LayerState.BufferData.verify|verify} messages.
                     * @function encode
                     * @memberof perfetto.protos.LayerState.BufferData
                     * @static
                     * @param {perfetto.protos.LayerState.IBufferData} message BufferData message or plain object to encode
                     * @param {$protobuf.Writer} [writer] Writer to encode to
                     * @returns {$protobuf.Writer} Writer
                     */
                    ...
                    /**
                     * Encodes the specified BufferData message, length delimited. Does not implicitly {@link perfetto.protos.LayerState.BufferData.verify|verify} messages.
                     * @function encodeDelimited
                     * @memberof perfetto.protos.LayerState.BufferData
                     * @static
                     * @param {perfetto.protos.LayerState.IBufferData} message BufferData message or plain object to encode
                     ...
                     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                     * @param {number} [length] Message length if known beforehand
                     * @returns {perfetto.protos.LayerState.BufferData} BufferData
                     * @throws {Error} If the payload is not a reader or valid buffer
                     * @throws {$protobuf.util.ProtocolError} If required fields are missing
                     */
                    BufferData.decode = function decode(reader, length) {
                        if (!(reader instanceof $Reader))
                            reader = $Reader.create(reader);
                        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.perfetto.protos.LayerState.BufferData();
                        while (reader.pos < end) {
                            var tag = reader.uint32();
                            switch (tag >>> 3) {
                            case 1: {
                    ...
                    BufferData.fromObject = function fromObject(object) {
                        if (object instanceof $root.perfetto.protos.LayerState.BufferData)
                            return object;
                        var message = new $root.perfetto.protos.LayerState.BufferData();
                     ...
                     * @memberof perfetto.protos.LayerState.BufferData
                     * @static
                     * @param {perfetto.protos.LayerState.BufferData} message BufferData
                     * @param {$protobuf.IConversionOptions} [options] Conversion options
                     * @returns {Object.<string,*>} Plain object
                     */
                    BufferData.toObject = function toObject(message, options) {
                        ...
                        if (message.pixelFormat != null && message.hasOwnProperty("pixelFormat"))
                            object.pixelFormat = options.enums === String ? $root.perfetto.protos.LayerState.BufferData.PixelFormat[message.pixelFormat] === undefined ? message.pixelFormat : $root.perfetto.protos.LayerState.BufferData.PixelFormat[message.pixelFormat] : message.pixelFormat;
                        if (message.usage != null && message.hasOwnProperty("usage"))
                    ...
                    BufferData.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                        ...
                        return typeUrlPrefix + "/perfetto.protos.LayerState.BufferData";
                    };
    
                    /**
                     * BufferDataChange enum.
                     * @name perfetto.protos.LayerState.BufferData.BufferDataChange
                     * @enum {number}
                    ...
                    /**
                     * PixelFormat enum.
                     * @name perfetto.protos.LayerState.BufferData.PixelFormat
                     * @enum {number}
                ...
                LayerState.WindowInfo = (function() {
                     ...
                     * @property {perfetto.protos.IRegionProto|null} [touchableRegion] WindowInfo touchableRegion
                     ...
                     * @property {perfetto.protos.IRectProto|null} [touchableRegionCrop] WindowInfo touchableRegionCrop
                     * @property {perfetto.protos.ITransform|null} [transform] WindowInfo transform
                     * @property {number|null} [inputConfig] WindowInfo inputConfig
                     */
                     ...
                     * @constructor
                     * @param {perfetto.protos.LayerState.IWindowInfo=} [properties] Properties to set
                     */
                     ...
                     * @memberof perfetto.protos.LayerState.WindowInfo
                     * @instance
                     */
                    ...
                    /**
                     * WindowInfo inputConfig.
                     * @member {number} inputConfig
                     * @memberof perfetto.protos.LayerState.WindowInfo
                     * @instance
                     */
                    WindowInfo.prototype.inputConfig = 0;
                     ...
                     * @static
                     * @param {perfetto.protos.LayerState.IWindowInfo=} [properties] Properties to set
                     * @returns {perfetto.protos.LayerState.WindowInfo} WindowInfo instance
                     */
                    ...
                    /**
                     * Encodes the specified WindowInfo message. Does not implicitly {@link perfetto.protos.LayerState.WindowInfo.verify|verify} messages.
                     * @function encode
                     * @memberof perfetto.protos.LayerState.WindowInfo
                     * @static
                     * @param {perfetto.protos.LayerState.IWindowInfo} message WindowInfo message or plain object to encode
                     * @param {$protobuf.Writer} [writer] Writer to encode to
                     * @returns {$protobuf.Writer} Writer
                     */
                    WindowInfo.encode = function encode(message, writer) {
                        ...
                        if (message.touchableRegion != null && Object.hasOwnProperty.call(message, "touchableRegion"))
                            $root.perfetto.protos.RegionProto.encode(message.touchableRegion, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                        ...
                        if (message.touchableRegionCrop != null && Object.hasOwnProperty.call(message, "touchableRegionCrop"))
                            $root.perfetto.protos.RectProto.encode(message.touchableRegionCrop, writer.uint32(/* id 10, wireType 2 =*/82).fork()).ldelim();
                        if (message.transform != null && Object.hasOwnProperty.call(message, "transform"))
                            $root.perfetto.protos.Transform.encode(message.transform, writer.uint32(/* id 11, wireType 2 =*/90).fork()).ldelim();
                        if (message.inputConfig != null && Object.hasOwnProperty.call(message, "inputConfig"))
                            writer.uint32(/* id 12, wireType 0 =*/96).uint32(message.inputConfig);
                        return writer;
                    };
    
                    /**
                     * Encodes the specified WindowInfo message, length delimited. Does not implicitly {@link perfetto.protos.LayerState.WindowInfo.verify|verify} messages.
                     * @function encodeDelimited
                     * @memberof perfetto.protos.LayerState.WindowInfo
                     * @static
                     * @param {perfetto.protos.LayerState.IWindowInfo} message WindowInfo message or plain object to encode
                     ...
                     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                     * @param {number} [length] Message length if known beforehand
                     * @returns {perfetto.protos.LayerState.WindowInfo} WindowInfo
                     * @throws {Error} If the payload is not a reader or valid buffer
                     * @throws {$protobuf.util.ProtocolError} If required fields are missing
                     */
                    WindowInfo.decode = function decode(reader, length) {
                        if (!(reader instanceof $Reader))
                            reader = $Reader.create(reader);
                        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.perfetto.protos.LayerState.WindowInfo();
                        while (reader.pos < end) {
                            var tag = reader.uint32();
                            switch (tag >>> 3) {
                            case 1: {
                    ...
                    WindowInfo.fromObject = function fromObject(object) {
                        if (object instanceof $root.perfetto.protos.LayerState.WindowInfo)
                            return object;
                        var message = new $root.perfetto.protos.LayerState.WindowInfo();
                        ...
                        if (object.touchableRegion != null) {
                            if (typeof object.touchableRegion !== "object")
                                throw TypeError(".perfetto.protos.LayerState.WindowInfo.touchableRegion: object expected");
                        ...
                        if (object.touchableRegionCrop != null) {
                            if (typeof object.touchableRegionCrop !== "object")
                                throw TypeError(".perfetto.protos.LayerState.WindowInfo.touchableRegionCrop: object expected");
                            message.touchableRegionCrop = $root.perfetto.protos.RectProto.fromObject(object.touchableRegionCrop);
                        }
                        if (object.transform != null) {
                            if (typeof object.transform !== "object")
                                throw TypeError(".perfetto.protos.LayerState.WindowInfo.transform: object expected");
                            message.transform = $root.perfetto.protos.Transform.fromObject(object.transform);
                        }
                     ...
                     * @memberof perfetto.protos.LayerState.WindowInfo
                     * @static
                     * @param {perfetto.protos.LayerState.WindowInfo} message WindowInfo
                     * @param {$protobuf.IConversionOptions} [options] Conversion options
                     * @returns {Object.<string,*>} Plain object
                     */
                    ...
                    WindowInfo.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                        ...
                        return typeUrlPrefix + "/perfetto.protos.LayerState.WindowInfo";
                    };
                ...
                /**
                 * DropInputMode enum.
                 * @name perfetto.protos.LayerState.DropInputMode
                 * @enum {number}
            ...
            protos.DisplayState = (function() {
                 ...
                 * @property {perfetto.protos.IRectProto|null} [layerStackSpaceRect] DisplayState layerStackSpaceRect
                 * @property {perfetto.protos.IRectProto|null} [orientedDisplaySpaceRect] DisplayState orientedDisplaySpaceRect
                 ...
                 * @constructor
                 * @param {perfetto.protos.IDisplayState=} [properties] Properties to set
                 */
                 ...
                 * DisplayState id.
                 * @member {number} id
                 * @memberof perfetto.protos.DisplayState
                 * @instance
                 */
                 ...
                 * @member {perfetto.protos.IRectProto|null|undefined} orientedDisplaySpaceRect
                 * @memberof perfetto.protos.DisplayState
                 * @instance
                 */
                 ...
                 * @static
                 * @param {perfetto.protos.IDisplayState=} [properties] Properties to set
                 * @returns {perfetto.protos.DisplayState} DisplayState instance
                 */
                ...
                /**
                 * Encodes the specified DisplayState message. Does not implicitly {@link perfetto.protos.DisplayState.verify|verify} messages.
                 * @function encode
                 * @memberof perfetto.protos.DisplayState
                 * @static
                 * @param {perfetto.protos.IDisplayState} message DisplayState message or plain object to encode
                 * @param {$protobuf.Writer} [writer] Writer to encode to
                 * @returns {$protobuf.Writer} Writer
                 */
                DisplayState.encode = function encode(message, writer) {
                    ...
                    if (message.layerStackSpaceRect != null && Object.hasOwnProperty.call(message, "layerStackSpaceRect"))
                        $root.perfetto.protos.RectProto.encode(message.layerStackSpaceRect, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
                    if (message.orientedDisplaySpaceRect != null && Object.hasOwnProperty.call(message, "orientedDisplaySpaceRect"))
                        $root.perfetto.protos.RectProto.encode(message.orientedDisplaySpaceRect, writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
                    if (message.width != null && Object.hasOwnProperty.call(message, "width"))
                ...
                /**
                 * Encodes the specified DisplayState message, length delimited. Does not implicitly {@link perfetto.protos.DisplayState.verify|verify} messages.
                 * @function encodeDelimited
                 * @memberof perfetto.protos.DisplayState
                 * @static
                 * @param {perfetto.protos.IDisplayState} message DisplayState message or plain object to encode
                 ...
                 * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                 * @param {number} [length] Message length if known beforehand
                 * @returns {perfetto.protos.DisplayState} DisplayState
                 * @throws {Error} If the payload is not a reader or valid buffer
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                DisplayState.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.perfetto.protos.DisplayState();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                        ...
                        case 7: {
                                message.orientedDisplaySpaceRect = $root.perfetto.protos.RectProto.decode(reader, reader.uint32());
                                break;
                            }
                        case 8: {
                                message.width = reader.uint32();
                ...
                DisplayState.verify = function verify(message) {
                    ...
                    if (message.orientedDisplaySpaceRect != null && message.hasOwnProperty("orientedDisplaySpaceRect")) {
                        var error = $root.perfetto.protos.RectProto.verify(message.orientedDisplaySpaceRect);
                        if (error)
                ...
                DisplayState.fromObject = function fromObject(object) {
                    if (object instanceof $root.perfetto.protos.DisplayState)
                        return object;
                    var message = new $root.perfetto.protos.DisplayState();
                    if (object.id != null)
                    ...
                    if (object.layerStackSpaceRect != null) {
                        if (typeof object.layerStackSpaceRect !== "object")
                            throw TypeError(".perfetto.protos.DisplayState.layerStackSpaceRect: object expected");
                    ...
                    if (object.orientedDisplaySpaceRect != null) {
                        if (typeof object.orientedDisplaySpaceRect !== "object")
                            throw TypeError(".perfetto.protos.DisplayState.orientedDisplaySpaceRect: object expected");
                        message.orientedDisplaySpaceRect = $root.perfetto.protos.RectProto.fromObject(object.orientedDisplaySpaceRect);
                    }
                    if (object.width != null)
                        message.width = object.width >>> 0;
                    if (object.height != null)
                 ...
                 * @memberof perfetto.protos.DisplayState
                 * @static
                 * @param {perfetto.protos.DisplayState} message DisplayState
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                DisplayState.toObject = function toObject(message, options) {
                    ...
                    if (message.orientedDisplaySpaceRect != null && message.hasOwnProperty("orientedDisplaySpaceRect"))
                        object.orientedDisplaySpaceRect = $root.perfetto.protos.RectProto.toObject(message.orientedDisplaySpaceRect, options);
                    if (message.width != null && message.hasOwnProperty("width"))
                        object.width = message.width;
                    if (message.height != null && message.hasOwnProperty("height"))
                        object.height = message.height;
                ...
                DisplayState.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/perfetto.protos.DisplayState";
                };
    
                /**
                 * Changes enum.
                 * @name perfetto.protos.DisplayState.Changes
                 * @enum {number}
